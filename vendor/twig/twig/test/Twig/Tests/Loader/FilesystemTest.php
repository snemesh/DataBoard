...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/index.html.old', $loader->getSourceContext('errors/index.html.old')->getName());
        $this->assertEquals(realpath($path.'/errors/index.html.old'), realpath($loader->getSourceContext('errors/index.html.old')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('index.html.old')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/index.html.old')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/index.html.old')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for index.html.old in the named namespace
        $namedSource = $loader->getSourceContext('@named/index.html.old')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get index.html.old from the main namespace
